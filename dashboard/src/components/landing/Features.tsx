...
const valueProps = [
  {
    ...
    description: 'Machine learning projections with confidence scores, ceilings, and floors that go beyond simple averages.',
    color: 'green',
  },
  {
    icon: Shield,
    title: 'Risk Management',
    description: 'Kelly Criterion bankroll management to optimize bet sizing and minimize risk of ruin.',
    color: 'blue',
  },
  {
    icon: Radio,
    title: 'Real-Time Intel',
    description: 'Live data integration with up-to-the-minute injury alerts and news impact analysis.',
    color: 'yellow',
  },
  {
    icon: Target,
    title: 'Leverage Plays',
    description: 'Automatic identification of high-confidence opportunities with low projected ownership.',
    color: 'purple',
  },
  {
    icon: BarChart3,
    title: 'ROI Tracking',
    description: 'Detailed analytics on your win rates and accuracy by contest type to refine your strategy.',
    color: 'orange',
  },
]
